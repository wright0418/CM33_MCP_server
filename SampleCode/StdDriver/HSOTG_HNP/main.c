 ...
 *           This sample needs two M3331 boards. One is as Host, the other is as Device.
 *
...
void SYS_Init(void)
{
    ...
    SYS->USBPHY = SYS_USBPHY_HSUSBEN_Msk | (0x3 << SYS_USBPHY_HSUSBROLE_Pos) | SYS_USBPHY_SBO_Msk;
    delay_us(20);
