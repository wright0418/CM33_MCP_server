...
int32_t CalPeriodTime(BPWM_T *BPWM, uint32_t u32Ch)
{
    ...
    printf("\nBPWM generate: \nHigh Period=15428 ~ 15430, Low Period=35999 ~ 36001, Total Period=51428 ~ 51430\n");
    printf("\nCapture Result: Rising Time = %d, Falling Time = %d \nHigh Period = %d, Low Period = %d, Total Period = %d.\n\n",
           u16RisingTime, u16FallingTime, u16HighPeriod, u16LowPeriod, u16TotalPeriod);
    if((u16HighPeriod < 15428) || (u16HighPeriod > 15430) || (u16LowPeriod < 35999) || (u16LowPeriod > 36001) || (u16TotalPeriod < 51428) || (u16TotalPeriod > 51430))
    {
    ...
    while(1)
    {
        ...
        */
        ...
        /* If input minimum frequency is 250Hz, user can calculate capture settings by follows.
           Capture clock source frequency = PLL/2 = 900000000 in the sample code.
