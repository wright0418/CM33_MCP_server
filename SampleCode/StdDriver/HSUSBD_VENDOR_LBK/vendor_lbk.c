 ...
 * @file     vendor_lbk.c
 * @version  V3.00
 * @brief    HSUSBD vendor loopback device sample file.
 *
...
volatile uint8_t  g_Ctrl_Buff[512] __attribute__((aligned(32)));
volatile uint8_t  g_Int_Buff[1024] __attribute__((aligned(32)));
volatile uint8_t  g_Bulk_Buff[512] __attribute__((aligned(32)));
volatile uint8_t  g_Iso_Buff[1024] __attribute__((aligned(32)));
