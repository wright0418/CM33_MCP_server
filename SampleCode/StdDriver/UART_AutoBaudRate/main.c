...
uint32_t GetUartBaudrate(UART_T* uart)
{
    ...
    switch((uint32_t)uart)
    {
        ...
        case UART2_BASE:
            ...
            u8UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART2DIV_Msk) >> CLK_CLKDIV1_UART2DIV_Pos;
            break;
        case UART3_BASE:
            u8UartClkSrcSel = (CLK->CLKSEL3 & CLK_CLKSEL3_UART3SEL_Msk) >> CLK_CLKSEL3_UART3SEL_Pos;
            u8UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART3DIV_Msk) >> CLK_CLKDIV1_UART3DIV_Pos;
            break;
        case UART4_BASE:
            u8UartClkSrcSel = (CLK->CLKSEL3 & CLK_CLKSEL3_UART4SEL_Msk) >> CLK_CLKSEL3_UART4SEL_Pos;
            u8UartClkDivNum = (CLK->CLKDIV1 & CLK_CLKDIV1_UART4DIV_Msk) >> CLK_CLKDIV1_UART4DIV_Pos;
            break;
        default:
            return 0;
    }
