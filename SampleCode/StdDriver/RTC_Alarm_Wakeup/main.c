 ...
 * @param       None
 * @return      None
 * @details     The RTC_IRQHandler is default IRQ of RTC, declared in startup_m3331.s.
 */
void RTC_IRQHandler(void)
{
...
int main(void)
{
    ...
    printf("# Set RTC current date/time: 2024/10/10 23:59:50.\n");
    printf("# Set RTC alarm date/time:   2024/10/10 23:59:55.\n");
    ...
    printf("\n\n");
    printf("# Set next RTC alarm date/time: 2024/10/11 00:00:05.\n");
    printf("# Wait system waken-up by RTC alarm interrupt event.\n");
    RTC_SetAlarmDate(2024, 10, 11);
