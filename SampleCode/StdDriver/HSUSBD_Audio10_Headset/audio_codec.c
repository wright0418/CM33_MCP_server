...
restart:
    ...
    I2C_WAIT_READY(I2C1);
    if(I2C_GET_STATUS(I2C1) == 0x38)
    {
        RecoveryFromArbLost();
        goto restart;
    }
    else if(I2C_GET_STATUS(I2C1) != 0x18)
        goto stop;
    ...
    else if(I2C_GET_STATUS(I2C1) != 0x28)
        goto stop;
...
uint8_t I2cWrite_MultiByteforNAU88L25(uint8_t chipadd, uint16_t subaddr, const uint8_t *p, uint32_t len)
{
    ...
    /* Send device address */
    I2C_SET_DATA(I2C1, chipadd);
    I2C_SET_CONTROL_REG(I2C1, I2C_CTL_SI);
    I2C_WAIT_READY(I2C1);

    /* Send register number and MSB of data */
    I2C_SET_DATA(I2C1, (uint8_t)(subaddr >> 8));
    I2C_SET_CONTROL_REG(I2C1, I2C_CTL_SI);
    I2C_WAIT_READY(I2C1);

    /* Send register number and MSB of data */
    I2C_SET_DATA(I2C1, (uint8_t)(subaddr));
    I2C_SET_CONTROL_REG(I2C1, I2C_CTL_SI);
    I2C_WAIT_READY(I2C1);
