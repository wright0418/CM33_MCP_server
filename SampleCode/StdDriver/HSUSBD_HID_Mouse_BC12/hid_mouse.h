 ...
 * @file     hid_mouse.h
 * @version  V3.00
 * @brief    HSUSBD HID mouse header file.
 *
...
typedef enum _HSUSBD_BC12_PD_STATUS
{
    HSUSBD_BC12_VBUS_OFF = 0,
    HSUSBD_BC12_CDP,
    HSUSBD_BC12_DCP,
    HSUSBD_BC12_SDP,
    HSUSBD_BC12_ERROR
} S_HSUSBD_BC12_PD_STATUS; /*!< Detection result of API HSUSBD_BC_Detect. */
