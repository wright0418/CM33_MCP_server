...
int32_t SYS_Init(void)
{
    ...
    CLK->AHBCLK0 |= CLK_AHBCLK0_CANFD0CKEN_Msk;
...
int main(void)
{
    ...
    FMC->ISPCTL |= FMC_ISPCTL_ISPEN_Msk | FMC_ISPCTL_APUEN_Msk | FMC_ISPCTL_DFUEN_Msk | FMC_ISPCTL_CFGUEN_Msk | FMC_ISPCTL_ISPFF_Msk;
