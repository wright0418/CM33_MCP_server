...
void WakeUpLVRFunction(uint32_t u32PDMode)
{
    ...
    printf("System wake-up if AVDD voltage is lower than LVR reset voltage.\n");
    printf("Enter to SPD Power-down mode......\n");
...
void CheckPowerSource(void)
{
    ...
    if((u32RegRstsrc & CLK_PMUSTS_RTCWK_Msk) != 0)
    {
        ...
        /* RTC wake-up source setting is kept after wake-up from SPD mode.  */
...
int main(void)
{
    ...
    printf("|[6] SPD Wake-up by BOD.                                          |\n");
    printf("|[7] SPD Wake-up by LVR.                                          |\n");
    printf("+-----------------------------------------------------------------+\n");
