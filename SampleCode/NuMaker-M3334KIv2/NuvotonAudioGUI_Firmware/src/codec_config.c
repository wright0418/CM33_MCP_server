...
// Command for 88C22(transfer via I2C1)
#if 1
...
/**
 * @brief       M3331Codec_InitCallback
 * 
 * @param[in]   None
 * 
 * @return      None
 * 
 * @details     The function is I2C1 callback function. It will be called in I2C1 IRQ handler.
 */
void M3331Codec_InitCallback(void)
{
 ...
 * @return      None
 * 
 * @details     This function is used to initialize NAU88C22 via I2C1
 */
 ...
 * @return      None
 * 
 * @details     This function is used to write NAU88C22 register via I2C1
 */
 ...
 * @return      None
 * 
 * @details     This function is used to initialize NAU88C22 as master mode via I2C1
 */
void NAU88C22_CodecMst_Init(uint32_t u32SampleRate)
{
    ...
    I2C_WriteNAU88C22(1,  0x1FF);                 // R1: REFIMP=80kΩ, ABIASEN=1, slow charge reference
    ...
    I2C_WriteNAU88C22(4,  0x010);                 // R4: I2S, 24bit
    ...
    I2C_WriteNAU88C22(52, 0x039);                 // LHP: Update=1, ZC=1, Mute=0, 0dB
    I2C_WriteNAU88C22(53, 0x039);                 // RHP
    I2C_WriteNAU88C22(54, 0x039);                 // LSPK
    I2C_WriteNAU88C22(55, 0x039);                 // RSPK
