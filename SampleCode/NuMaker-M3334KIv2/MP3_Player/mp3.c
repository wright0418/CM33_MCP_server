...
/* PCM buffer available flags (1 = buffer is empty and ready to be filled) */
volatile uint8_t g_u8PCMBuf0Empty = 0;
volatile uint8_t g_u8PCMBuf1Empty = 0;
...
void MP3Player(void)
{
    ...
    while(1)
    {
        ...
        */
        ...
        u32Timeout = 1000000;
        while((g_u8PCMBuf0Empty == 0) && (g_u8PCMBuf1Empty == 0) && (u32Timeout-- > 0)){}
        if(u32Timeout == 0)
        {
    ...
    while(g_u8PCMBuf0Empty && g_u8PCMBuf1Empty){}
