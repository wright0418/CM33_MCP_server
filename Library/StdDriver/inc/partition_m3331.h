...
#if !(defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3)) && !defined(__NONSECURE_CODE)
#ifndef PARTITION_M3331
#define PARTITION_M3331
...
/*
// Bit 0..27
// <o.0..27> Secure SRAM Size              <0=> 0 KB
//                                         <0x2000=> 8KB
//                                         <0x4000=> 16KB
//                                         <0x6000=> 24KB
//                                         <0x8000=> 32KB
...
/*
//     <o>Secure Flash ROM Size <0x1000-0x80000:0x1000>
*/
...
//   <o.15>  HSOTG      <0=> Secure <1=> Non-Secure
//   <h> TIMER
...
//   <o.28>  BPWM2      <0=> Secure <1=> Non-Secure
//   <o.29>  BPWM3      <0=> Secure <1=> Non-Secure
//   <o.30>  BPWM4      <0=> Secure <1=> Non-Secure
//   <o.31>  BPWM5      <0=> Secure <1=> Non-Secure
//   </h>
*/
...
//   </h>
//   <o.6>  I3C0        <0=> Secure <1=> Non-Secure
//   <h> LLSI
...
/*
// Module 0..31
//   <o.16>  EQEI0      <0=> Secure <1=> Non-Secure
...
/*
// <h> GPIO Pin Secure Attribution Configuration
*/
...
//   <o.15>  PF15       <0=> Secure <1=> Non-Secure
//   </h>
*/
...
/*
     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4     0x3f000                 /* start address of SAU region 4 */

/*
     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END4       0x3f7ff                 /* end address of SAU region 4 */
...
/*
     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END5       0x1007FFFF      /* end address of SAU region 5 */
...
#endif  /* PARTITION_M3331 */
#else   /* if not define __ARM_FEATURE_CMSE */

#if (__ARM_FEATURE_CMSE == 3)


    /*
    Default M3331 pritition configuration file is for non-TrustZone sample code only.
    If user wants to use TrurstZone, they should have their partition_m3331.h.
    For TrustZone projects, path of local partition_m3331.h should be in the
    front of the include path list to make sure local partition_m3331.h is used.

    It also apply to non-secure project of the TrustZone projects.

    */
    #error "Link to default partition_m3331.h in secure mode. Please check your include path."
#endif

#endif  /* if not define __ARM_FEATURE_CMSE */
