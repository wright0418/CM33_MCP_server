...
#define EADC_SOFTWARE_TRIGGER               (0x0UL << EADC_SCTL_TRGSEL_Pos)     /*!< Software trigger \hideinitializer */
#define EADC_FALLING_EDGE_TRIGGER           (EADC_SCTL_EXTFEN_Msk | (0x1UL << EADC_SCTL_TRGSEL_Pos))                        /*!< STADC pin falling edge trigger \hideinitializer */
#define EADC_RISING_EDGE_TRIGGER            (EADC_SCTL_EXTREN_Msk | (0x1UL << EADC_SCTL_TRGSEL_Pos))                        /*!< STADC pin rising edge trigger \hideinitializer */
...
#define EADC_ADINT0_TRIGGER                 (0x2UL << EADC_SCTL_TRGSEL_Pos)     /*!< ADC ADINT0 interrupt EOC pulse trigger \hideinitializer */
#define EADC_ADINT1_TRIGGER                 (0x3UL << EADC_SCTL_TRGSEL_Pos)     /*!< ADC ADINT1 interrupt EOC pulse trigger \hideinitializer */
#define EADC_TIMER0_TRIGGER                 (0x4UL << EADC_SCTL_TRGSEL_Pos)     /*!< Timer0 overflow pulse trigger \hideinitializer */
#define EADC_TIMER1_TRIGGER                 (0x5UL << EADC_SCTL_TRGSEL_Pos)     /*!< Timer1 overflow pulse trigger \hideinitializer */
#define EADC_TIMER2_TRIGGER                 (0x6UL << EADC_SCTL_TRGSEL_Pos)     /*!< Timer2 overflow pulse trigger \hideinitializer */
#define EADC_TIMER3_TRIGGER                 (0x7UL << EADC_SCTL_TRGSEL_Pos)     /*!< Timer3 overflow pulse trigger \hideinitializer */
#define EADC_EPWM0TG0_TRIGGER               (0x8UL << EADC_SCTL_TRGSEL_Pos)     /*!< EPWM0TG0 trigger \hideinitializer */
#define EADC_EPWM0TG1_TRIGGER               (0x9UL << EADC_SCTL_TRGSEL_Pos)     /*!< EPWM0TG1 trigger \hideinitializer */
...
#define EADC_BPWM2TG_TRIGGER                (0x22UL << EADC_SCTL_TRGSEL_Pos)    /*!< BPWM2TG trigger \hideinitializer */
#define EADC_BPWM3TG_TRIGGER                (0x23UL << EADC_SCTL_TRGSEL_Pos)    /*!< BPWM3TG trigger \hideinitializer */
#define EADC_BPWM4TG_TRIGGER                (0x24UL << EADC_SCTL_TRGSEL_Pos)    /*!< BPWM4TG trigger \hideinitializer */
#define EADC_BPWM5TG_TRIGGER                (0x25UL << EADC_SCTL_TRGSEL_Pos)    /*!< BPWM5TG trigger \hideinitializer */
#define EADC_ACMP0INT_TRIGGER               (0x26UL << EADC_SCTL_TRGSEL_Pos)    /*!< ACMP0 interrupt trigger \hideinitializer */
#define EADC_ACMP1INT_TRIGGER               (0x27UL << EADC_SCTL_TRGSEL_Pos)    /*!< ACMP1 interrupt trigger \hideinitializer */

#define EADC_SCTL_TRGDLYDIV_DIVIDER_1       (0x0UL << EADC_SCTL_TRGDLYDIV_Pos)  /*!< Trigger delay clock frequency is EADC_CLK/1 \hideinitializer */
#define EADC_SCTL_TRGDLYDIV_DIVIDER_2       (0x1UL << EADC_SCTL_TRGDLYDIV_Pos)  /*!< Trigger delay clock frequency is EADC_CLK/2 \hideinitializer */
#define EADC_SCTL_TRGDLYDIV_DIVIDER_4       (0x2UL << EADC_SCTL_TRGDLYDIV_Pos)  /*!< Trigger delay clock frequency is EADC_CLK/4 \hideinitializer */
#define EADC_SCTL_TRGDLYDIV_DIVIDER_16      (0x3UL << EADC_SCTL_TRGDLYDIV_Pos)  /*!< Trigger delay clock frequency is EADC_CLK/16 \hideinitializer */


/*---------------------------------------------------------------------------------------------------------*/
/* EADC_CMP Constant Definitions                                                                           */
/*---------------------------------------------------------------------------------------------------------*/
#define EADC_CMP_CMPCOND_LESS_THAN          (0UL << EADC_CMP_CMPCOND_Pos)   /*!< The compare condition is "less than" CMPDAT setting \hideinitializer */
#define EADC_CMP_CMPCOND_GREATER_OR_EQUAL   (1UL << EADC_CMP_CMPCOND_Pos)   /*!< The compare condition is "greater than or equal to" CMPDAT setting \hideinitializer */
#define EADC_CMP_CMPWEN_ENABLE              (1UL << EADC_CMP_CMPWEN_Pos)    /*!< Compare window mode enable (Note: Support at EADC_CMP0 and EADC_CMP2 register) \hideinitializer */
#define EADC_CMP_CMPWEN_DISABLE             (0UL << EADC_CMP_CMPWEN_Pos)    /*!< Compare window mode disable (Note: Support at EADC_CMP0 and EADC_CMP2 register) \hideinitializer */
...
/**
  ...
  *             If user enable DBMEN (EADC_MnCTL1[20], n=0~3), the double buffer mode will enable.
  * \hideinitializer
  */
...
/**
  ...
  * @return     None
  * @details    The A/D converter generates ADIFn (n=0~3, EADC_STATUS2[3:0]) at the start of conversion.
  * \hideinitializer
  */
...
/**
  ...
  * @param[in]  u32ModuleNum    Decides the sample module number, valid value are from 0 to 15.
  * @return     None
  * @details    The A/D converter generates ADIFn (n=0~3, EADC_STATUS2[3:0]) at the end of conversion.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This STPFn (n=0~18, EADC_PENDSTS[18:0]) bit remains 1 during pending state, when the respective ADC conversion is end, the STPFn bit is automatically cleared to 0.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This macro is used to read RESULT (EADC_DATn[15:0], n=0~18) field to get conversion data.
  * \hideinitializer
  */
...
/**
  ...
  * \hideinitializer
  */
#define EADC_GET_DATA_OVERRUN_FLAG(eadc, u32ModuleMask) (((((eadc)->STATUS0 & EADC_STATUS0_OV_Msk) >> EADC_STATUS0_OV_Pos) | ((eadc)->STATUS1 & EADC_STATUS1_OV_Msk)) & (u32ModuleMask))
...
/**
  ...
  *             Means EADC will assert comparator 1 flag if sample module 5 conversion result is greater or equal to 0x800 for 10 times continuously, and a compare interrupt request is generated.
  * \hideinitializer
  */
...
/**
  ...
  *             Means EADC will assert comparator 3 flag if sample module 5 conversion result is greater or equal to 0x800 for 10 times continuously, and a compare interrupt request is generated.
  * \hideinitializer
  */
...
/**
  ...
  * @param[in]  u32ModuleNum    Decides the sample module number, valid value are from 0 to 18.
  * @return     None
  * @details    The 12-bit conversion result will be left aligned and stored in EADC_DATn[15:4](n=0~18).
  * \hideinitializer
  */
...
/**
  ...
  * @param[in]  u32ModuleNum    Decides the sample module number, valid value are from 0 to 18.
  * @return     None
  * @details    The 12-bit conversion result will be right aligned and stored in EADC_DATn[11:0](n=0~18).
  * \hideinitializer
  */
...
/**
  ...
  * @note       This average mode needs to work with accumulated mode that configured by ACU (EADC_MnCTL1[7:4], n=0~18) bit field.
  * \hideinitializer
  */
...
/**
  ...
  * @note       This function is workable only when any one of INTPOS (EADC_SCTLn[5], n=0~15) is set.
  * \hideinitializer
  */
