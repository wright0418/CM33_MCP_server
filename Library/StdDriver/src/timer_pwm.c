...
uint32_t TPWM_ConfigOutputFreqAndDuty(TIMER_T *timer, uint32_t u32Frequency, uint32_t u32DutyCycle)
{
    ...
    uint32_t u32Prescaler = 0x1000UL, u32Period = 0, u32CMP;
...
/**
  ...
  *                                 - \ref TPWM_BRAKE_SOURCE_EDGE_SYS_NSRAM
  *                                 - \ref TPWM_BRAKE_SOURCE_EDGE_SYS_ECC
  *                                 - \ref TPWM_BRAKE_SOURCE_EDGE_SYS_NSECC
  ...
  *                                 - \ref TPWM_BRAKE_SOURCE_LEVEL_SYS_NSRAM
  *                                 - \ref TPWM_BRAKE_SOURCE_LEVEL_SYS_ECC
  *                                 - \ref TPWM_BRAKE_SOURCE_LEVEL_SYS_NSECC
  *
  * @return     None
  *
...
{
    timer->PWMFAILBRK |= ((u32BrakeSource >> 16) & 0x7FUL);
