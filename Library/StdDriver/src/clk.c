 ...
 * @file     clk.c
 * @version  V3.00
 * @brief    M3331 series CLK driver source file
 *
...
{
    volatile uint32_t u32SysTickTICKINT = 0, u32HIRCTCTL = 0;
...
uint32_t CLK_GetCPUFreq(void)
{
    ...
    {
        PllClock = 0UL;         /* PLL is in power down mode or fixed low */
    }
...
/**
  ...
  * @param[in]  u32Hclk is HCLK frequency. The range of u32Hclk is 50MHz ~ 180MHz.
  * @return     HCLK frequency
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    /* Check HCLK frequency range is 50MHz ~ 180MHz */
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if(SystemCoreClock <= FREQ_160MHZ)
    {
    ...
    else /* SystemCoreClock < FREQ_24MHZ */
    {
...
/**
  ...
  * |\ref SPI2_MODULE    |\ref CLK_CLKSEL2_SPI2SEL_PLL_DIV2      | x                             |
  ...
  * |\ref BPWM2_MODULE   |\ref CLK_CLKSEL2_BPWM2SEL_HCLK         | x                             |
  * |\ref BPWM2_MODULE   |\ref CLK_CLKSEL2_BPWM2SEL_PCLK0        | x                             |
  * |\ref BPWM3_MODULE   |\ref CLK_CLKSEL2_BPWM3SEL_HCLK         | x                             |
  * |\ref BPWM3_MODULE   |\ref CLK_CLKSEL2_BPWM3SEL_PCLK1        | x                             |
  * |\ref BPWM4_MODULE   |\ref CLK_CLKSEL2_BPWM4SEL_HCLK         | x                             |
  * |\ref BPWM4_MODULE   |\ref CLK_CLKSEL2_BPWM4SEL_PCLK0        | x                             |
  * |\ref BPWM5_MODULE   |\ref CLK_CLKSEL2_BPWM5SEL_HCLK         | x                             |
  * |\ref BPWM5_MODULE   |\ref CLK_CLKSEL2_BPWM5SEL_PCLK1        | x                             |
  * |\ref I2S0_MODULE    |\ref CLK_CLKSEL3_I2S0SEL_HXT           |\ref CLK_CLKDIV1_I2S0(x)       |
  * |\ref I2S0_MODULE    |\ref CLK_CLKSEL3_I2S0SEL_PLL_DIV2      |\ref CLK_CLKDIV1_I2S0(x)       |
  * |\ref I2S0_MODULE    |\ref CLK_CLKSEL3_I2S0SEL_PCLK0         |\ref CLK_CLKDIV1_I2S0(x)       |
  * |\ref I2S0_MODULE    |\ref CLK_CLKSEL3_I2S0SEL_HIRC          |\ref CLK_CLKDIV1_I2S0(x)       |
  * |\ref I3C0_MODULE    |\ref CLK_CLKSEL3_I3C0SEL_HXT           | x                             |
  * |\ref I3C0_MODULE    |\ref CLK_CLKSEL3_I3C0SEL_HCLK          | x                             |
  * |\ref I3C0_MODULE    |\ref CLK_CLKSEL3_I3C0SEL_PCLK0         | x                             |
  * |\ref I3C0_MODULE    |\ref CLK_CLKSEL3_I3C0SEL_HIRC          | x                             |
  * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_HXT          |\ref CLK_CLKDIV1_UART2(x)      |
  * |\ref UART2_MODULE   |\ref CLK_CLKSEL3_UART2SEL_PLL_DIV2     |\ref CLK_CLKDIV1_UART2(x)      |
  ...
  * |\ref UART3_MODULE   |\ref CLK_CLKSEL3_UART3SEL_PLL_DIV2     |\ref CLK_CLKDIV1_UART3(x)      |
  ...
  * |\ref UART4_MODULE   |\ref CLK_CLKSEL3_UART4SEL_PLL_DIV2     |\ref CLK_CLKDIV1_UART4(x)      |
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    uint32_t au32SelTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0xCUL};  /* CLK_CLKSEL0~3 */
    uint32_t au32DivTbl[2] = {0x0UL, 0x4UL};                /* CLK_CLKDIV0~1 */
...
/**
  ...
  *             - \ref CLK_PWRCTL_EXTEN_Msk  : Enable HXT clock and HXT is external clock mode.
  *             - \ref CLK_PWRCTL_HXTEN_Msk  : Enable HXT clock and HXT is crystal mode.
  *             - \ref CLK_PWRCTL_LXTEN_Msk  : Enable LXT clock.
  *             - \ref CLK_PWRCTL_HIRCEN_Msk : Enable HIRC clock.
  *             - \ref CLK_PWRCTL_LIRCEN_Msk : Enable LIRC clock.
  * @return     None
...
{
    if( (u32ClkMask & CLK_PWRCTL_EXTEN_Msk) == CLK_PWRCTL_EXTEN_Msk )
    {
        /* HXT is external clock mode */
        SET_GPIO_PF3(); /* Set PF.3 function to GPIO */

        /* HXT crystal type default setting is GM mode.
           When HXT works as external clock mode, it must be set as GM mode.
           Just set it to GM mode again here for safe. */
        CLK->PWRCTL |= CLK_PWRCTL_HXTSELTYP_Msk;

    }
    else if( (u32ClkMask & CLK_PWRCTL_EXTEN_Msk) == CLK_PWRCTL_HXTEN_Msk )
    {
        CLK->PWRCTL &= ~CLK_PWRCTL_HXTMD_Msk; /* HXT is crystal mode */
        SET_XT1_OUT_PF2(); /* Set PF.2 function to XT1_OUT */
        SET_XT1_IN_PF3();  /* Set PF.3 function to XT1_IN  */
    }

    if( (u32ClkMask & CLK_PWRCTL_LXTEN_Msk) == CLK_PWRCTL_LXTEN_Msk )
    {
        SET_X32_OUT_PF4(); /* Set PF.4 function to X32_OUT */
        SET_X32_IN_PF5();  /* Set PF.5 function to X32_IN  */
    }

    CLK->PWRCTL |= u32ClkMask; /* Enable clock source */
}
...
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    ...
    uint32_t au32ClkEnTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0x34UL};
...
{
    uint32_t u32PllSrcClk, u32NR, u32NF, u32NO, u32PllClk = 0;
    ...
    if((CLK->CLKSEL0 & CLK_CLKSEL0_HCLKSEL_Msk) == CLK_CLKSEL0_HCLKSEL_PLL)
    {
        ...
        else                        /* PLL is in normal mode */
        {
            ...
            if(u32PllReg & CLK_PLLCTL_PLLSRC_Msk)
            {
                u32PllSrcClk = (__HIRC >> 2);  /* PLL source clock from HIRC/4 */
            }
            else
            {
                u32PllSrcClk = __HXT;     /* PLL source clock from HXT */
            }

            /* Calculate PLL frequency */
            if(u32PllReg & CLK_PLLCTL_BP_Msk)
            {
                PllClock = u32PllSrcClk;  /* PLL is in bypass mode */
            }
            else
            {
                /* PLL is output enabled in normal work mode */
                ...
                /* u32FIN is shifted 2 bits to avoid overflow */
                PllClock = (((u32PllSrcClk >> 2) * (u32NF << 1)) / (u32NR * u32NO) << 2);
            }
        }
    ...
    else
    {
        if(u32PllClkSrc == CLK_PLLCTL_PLLSRC_HXT)
        {
            ...
            u32PllClk = FREQ_160MHZ;
        }
        else
        {
            /* Apply default PLL setting and return */
            CLK->PLLCTL = CLK_PLLCTL_160MHz_HIRC_DIV4;
